...
export default function Template() {
  return (
    <Section className='template bg-section shadow-section-inner dark:bg-section-inner-dark dark:shadow-section-inner-dark flex justify-between gap-x-[22px] rounded-xl px-5 py-2.5'>
